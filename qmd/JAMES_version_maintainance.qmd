...
-   Move `vignettes/articles/geting_started.html` to `docs/articles/gatting_started.html`
-   Move `vignettes/articles/geting_started_files/` to `docs/articles/gatting_started_files/`
