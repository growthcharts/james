...
The current OpenAPI definition of JAMES is at <https://app.swaggerhub.com/apis-docs/stefvanbuuren/james/1.5.0s> (version 1.5.0). Note that this definition may evolve over time.
