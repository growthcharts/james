...
The web service can be used by anyone interested in high-quality charts for
...
The functions `upload_bds()` and `request_chart()` in the 
`jamesclient` package 
...
- add functionality to test for Dutch guidelines for referral [DONE, for length]
