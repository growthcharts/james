...
site_laura <- request_site(laura, host = host3)
site_laura_gro <- request_site(laura_gro, host = host3)
site_laura_dev <- request_site(laura_dev, host = host3)

site_kevin  <- request_site(kevin, host = host3)
site_kevin_gro <- request_site(kevin_gro, host = host3)
site_kevin_dev <- request_site(kevin_dev, host = host3)
