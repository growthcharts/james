...
test_that("fetch_loc() on client3.json is silent",
...
test_that("fetch_loc() on not_a_vector.json has messages",
          expect_message(fetch_loc(js)))
test_that("screen_curves() on not_a_vector.json has messages",
          expect_warning(screen_curves(js)))
test_that("screen_growth() on not_a_vector.json has messages",
...
test_that("fetch_loc() on http400.json has messages",
          expect_silent(fetch_loc(js)))
